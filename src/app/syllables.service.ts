...
export class SyllablesService extends FlashcardService {
  ...
  hiragana = 
    ...
    s: [{german: 'sa', hiragana: 'さ', katakana: 'サ'},
    ...
    {german: 'so', hiragana: 'そ', katakana: 'ソ'}],
     ...
     t: [{german: 'ta', hiragana: 'た', katakana: 'タ'},
    ...
    {german: 'to', hiragana: 'と', katakana: 'ト'}],
     ...
     na: [{german: 'na', hiragana: 'な', katakana: 'ナ'},
    ...
    {german: 'no', hiragana: 'の', katakana: 'ノ'}],
     ...
     h: [{german: 'ha', hiragana: 'は', katakana: 'ハ'},
    ...
    {german: 'ho', hiragana: 'ほ', katakana: 'ホ'}],
     ...
     m: [{german: 'ma', hiragana: 'ま', katakana: 'マ'},
    ...
    {german: 'mo', hiragana: 'も', katakana: 'モ'}],
     ...
     y: [{german: 'ya', hiragana: 'や', katakana: 'ヤ'},
    {german: 'yu', hiragana: 'ゆ', katakana: 'ユ'},
    {german: 'yo', hiragana: 'よ', katakana: 'ヨ'}],

     r: [{german: 'ra', hiragana: 'ら', katakana: 'ラ'},
    ...
    {german: 'ro', hiragana: 'ろ', katakana: 'ロ'}],
     ...
     w: [{german: 'wa', hiragana: 'わ', katakana: 'ワ'},
    {german: 'wo', hiragana: 'を', katakana: 'ヲ'}],

    n: [{german: 'n', hiragana: 'ん', katakana: 'ン'}]}
  ;
  ...
  getForRows(rows: Array<string>) {
    let syllables = [];
    rows.forEach(row => {
      syllables = syllables.concat(this.hiragana[row]);
    });
    return syllables;
  }
}
